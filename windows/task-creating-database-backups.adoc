...
xref:reference-the-smosmsapbackup-create-command.adoc[The smsap backup create command]

xref:task-creating-or-updating-post-scripts.adoc[Creating or updating the post scripts]
