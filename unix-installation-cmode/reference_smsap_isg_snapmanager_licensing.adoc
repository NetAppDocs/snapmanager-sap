---
permalink: unix-installation-cmode/reference_smsap_isg_snapmanager_licensing.html
sidebar: sidebar
keywords: snapmanager, license, storage, system, license, require, enable, operation, licensing, per-server, database, per-storage
