---
permalink: unix-installation-cmode/task_smsap_isg_backing_up_your_database.html
sidebar: sidebar
keywords: creating, create, back, up, database, schedule, backup, initial, verification
